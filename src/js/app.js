...
function crearGaleria(){
    ...
    for(let i=1; i<=12; i++){
        ...
        imagen.innerHTML =`
        <source srcset="/festival-landing-page/build/img/thumb/${i}.webp" type="image/webp">
        <img  loading="lazy" width="200" height="300" src="/festival-landing-page/build/img/thumb/${i}.jpg" alt="Imagen Galería">
        `;
...
function mostrarImagen(imgPresiona){
    ...
    imagen.innerHTML =`
        <source srcset="/festival-landing-page/build/img/grande/${imgPresiona}.webp" type="image/webp">
        <img  loading="lazy" width="200" height="300" src="/festival-landing-page/build/img/grande/${imgPresiona}.jpg" alt="Imagen Galería">
        `;
